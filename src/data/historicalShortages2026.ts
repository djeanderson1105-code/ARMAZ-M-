...
const RAW_SHORTAGE_EVENTS_2026: ShortageHistoricalItem[] = [
  ...
  // SETEMBRO 2026 (Carregamento: R$ 673,50 | Descarregamento: R$ 58,00)
  {
    month: 9, day: 9, tipo: "carregamento",
    motivo: "Falta de SKU no Carregamento (Armazém)",
    subMotivo: "Separação Incompleta no Palete",
    produtoCodigo: "9068", produtoDescricao: "SKOL LATA 350ML SH C/12 NPAL",
    quantidade: 21, valorUnitario: 28.50, fatorHecto: 0.042, fatorEmbalagem: 12,
    motorista: "VALDKLEBER DE SOUZA ALEXANDRE", motoristaCpf: "058.129.184-06", rota: "R110",
    mapa: "M9020", nf: "259780", clienteNb: "CLI2290", clienteNome: "CHOPPERIA DO CENTRO",
    turno: "Diurno (Turno 1)", horario: "06:30",
    observacao: "Falta de 21 caixas identificada no CD. Baixa física regularizada."
  },
  {
    month: 9, day: 16, tipo: "entrega",
    motivo: "Falta no Descarregamento (Rota / Entrega)",
    subMotivo: "Não Localizado no Descarregamento do PDV",
    produtoCodigo: "9067", produtoDescricao: "ANTARCTICA PILSEN LATA 350ML SH C/12 NPAL",
    quantidade: 2, valorUnitario: 29.00, fatorHecto: 0.042, fatorEmbalagem: 12,
    motorista: "VALDKLEBER DE SOUZA ALEXANDRE", motoristaCpf: "058.129.184-06", rota: "R110",
    mapa: "M9045", nf: "259920", clienteNb: "CLI3365", clienteNome: "MERCADINHO BEIRA RIO",
    ajudante1: "FELIPE GOMES DA SILVA", ajudante1Cpf: "700.552.584-17",
    turno: "Diurno (Turno 1)", horario: "14:30",
    observacao: "Falta de 2 cx no PDV (R$ 58,00). Vale emitido e assinado."
  },
  {
    month: 9, day: 24, tipo: "carregamento",
    motivo: "Falta de SKU no Carregamento (Armazém)",
    subMotivo: "Separação Incompleta no Palete",
    produtoCodigo: "13061", produtoDescricao: "H2OH LIMONETO PET 500ML SHRINK C/12 NPAL",
    quantidade: 2, valorUnitario: 37.50, fatorHecto: 0.06, fatorEmbalagem: 12,
    motorista: "JEFFERSON JONES PAULINO COSTA", motoristaCpf: "084.721.434-19", rota: "R108",
    mapa: "M9075", nf: "260050", clienteNb: "CLI3380", clienteNome: "BAR DA SERRA",
    turno: "Diurno (Turno 1)", horario: "07:05",
    observacao: "Ajuste na conferência de carga."
  },

  // OUTUBRO 2026 (Carregamento: R$ 684,00 | Descarregamento: R$ 64,00)
  {
    month: 10, day: 14, tipo: "carregamento",
    motivo: "Falta de SKU no Carregamento (Armazém)",
    subMotivo: "Separação Incompleta no Palete",
    produtoCodigo: "21020", produtoDescricao: "BUDWEISER LT SLEEK 350ML CX CART C 12",
    quantidade: 19, valorUnitario: 32.00, fatorHecto: 0.042, fatorEmbalagem: 12,
    motorista: "EWERTON RODRIGUES DA SILVA", motoristaCpf: "116.515.224-05", rota: "R112",
    mapa: "M10030", nf: "260210", clienteNb: "CLI2310", clienteNome: "DISTRIBUIDORA SAPE SUL",
    turno: "Diurno (Turno 1)", horario: "06:40",
    observacao: "Baixa física regularizada no CD Pau Brasil."
  },
  {
    month: 10, day: 21, tipo: "entrega",
    motivo: "Falta no Descarregamento (Rota / Entrega)",
    subMotivo: "Divergência na Conferência do PDV",
    produtoCodigo: "21020", produtoDescricao: "BUDWEISER LT SLEEK 350ML CX CART C 12",
    quantidade: 2, valorUnitario: 32.00, fatorHecto: 0.042, fatorEmbalagem: 12,
    motorista: "EWERTON RODRIGUES DA SILVA", motoristaCpf: "116.515.224-05", rota: "R112",
    mapa: "M10065", nf: "260450", clienteNb: "CLI3390", clienteNome: "BAR DA ESQUINA",
    ajudante1: "VITOR MACENA GOMES", ajudante1Cpf: "705.138.374-42",
    turno: "Diurno (Turno 1)", horario: "15:10",
    observacao: "Falta de 2 cx no PDV (R$ 64,00). Vale emitido e assinado."
  },
  {
    month: 10, day: 28, tipo: "carregamento",
    motivo: "Falta de SKU no Carregamento (Armazém)",
    subMotivo: "Separação Incompleta no Palete",
    produtoCodigo: "9083", produtoDescricao: "SKOL LT 473ML SH C/12 NPAL",
    quantidade: 2, valorUnitario: 38.00, fatorHecto: 0.05676, fatorEmbalagem: 12,
    motorista: "JOSE HONORIO DA SILVA", motoristaCpf: "062.819.344-90", rota: "R105",
    mapa: "M10090", nf: "260680", clienteNb: "CLI3400", clienteNome: "RESTAURANTE DO PORTO",
    turno: "Diurno (Turno 1)", horario: "07:15",
    observacao: "Ajustado na separação."
  },

  // NOVEMBRO 2026 (Carregamento: R$ 667,00 | Descarregamento: R$ 50,00)
  {
    month: 11, day: 11, tipo: "carregamento",
    motivo: "Falta de SKU no Carregamento (Armazém)",
    subMotivo: "Separação Incompleta no Palete",
    produtoCodigo: "2546", produtoDescricao: "ORIGINAL 600ML",
    quantidade: 10, valorUnitario: 61.00, fatorHecto: 0.072, fatorEmbalagem: 12,
    motorista: "GILMAR DOS SANTOS FERNANDES", motoristaCpf: "058.142.584-70", rota: "R114",
    mapa: "M11025", nf: "260890", clienteNb: "CLI2330", clienteNome: "PANIFICADORA SAO JOSE",
    turno: "Diurno (Turno 1)", horario: "06:35",
    observacao: "Falta de 10 caixas no CD. Regularizado internamente."
  },
  {
    month: 11, day: 18, tipo: "entrega",
    motivo: "Falta no Descarregamento (Rota / Entrega)",
    subMotivo: "Não Localizado no Descarregamento do PDV",
    produtoCodigo: "2319", produtoDescricao: "GUARANA CHP ANTARCTICA PET 1L CAIXA C/12",
    quantidade: 2, valorUnitario: 25.00, fatorHecto: 0.12, fatorEmbalagem: 12,
    motorista: "JOSENILSON INACIO DE ANDRADE", motoristaCpf: "095.612.484-77", rota: "R107",
    mapa: "M11050", nf: "261050", clienteNb: "CLI3410", clienteNome: "CHURRASCARIA TROPICAL",
    ajudante1: "VALTEIR BATISTA DE OLIVEIRA", ajudante1Cpf: "103.582.914-40",
    turno: "Diurno (Turno 1)", horario: "13:50",
    observacao: "Falta de 2 cx no PDV (R$ 50,00). Vale emitido e assinado."
  },
  {
    month: 11, day: 25, tipo: "carregamento",
    motivo: "Falta de SKU no Carregamento (Armazém)",
    subMotivo: "Separação Incompleta no Palete",
    produtoCodigo: "2349", produtoDescricao: "GUARANA CHP ANTARCTICA PET 2L CAIXA C/6",
    quantidade: 2, valorUnitario: 28.50, fatorHecto: 0.12, fatorEmbalagem: 6,
    motorista: "EDENILSON DE SOUSA SILVA", motoristaCpf: "104.695.814-33", rota: "R101",
    mapa: "M11070", nf: "261220", clienteNb: "CLI2350", clienteNome: "MERCADO DO POVO",
    turno: "Diurno (Turno 1)", horario: "07:00",
    observacao: "Ajuste na conferência."
  },

  // DEZEMBRO 2026 (Carregamento: R$ 631,50 | Descarregamento: R$ 80,00)
  {
    month: 12, day: 9, tipo: "carregamento",
    motivo: "Falta de SKU no Carregamento (Armazém)",
    subMotivo: "Separação Incompleta no Palete",
    produtoCodigo: "23186", produtoDescricao: "SPATEN N 600ML",
    quantidade: 9, valorUnitario: 60.50, fatorHecto: 0.072, fatorEmbalagem: 12,
    motorista: "DANILLO PEREIRA DOS SANTOS SILVA", motoristaCpf: "713.650.714-64", rota: "R111",
    mapa: "M12020", nf: "261450", clienteNb: "CLI2370", clienteNome: "SUPERMERCADO NATAL",
    turno: "Diurno (Turno 1)", horario: "06:45",
    observacao: "Falta de 9 cx no CD. Baixa física regularizada."
  },
  {
    month: 12, day: 16, tipo: "entrega",
    motivo: "Falta no Descarregamento (Rota / Entrega)",
    subMotivo: "Não Localizado na Descarga",
    produtoCodigo: "1743", produtoDescricao: "ANTARCTICA PILSEN GFA VD 1L COM TTC",
    quantidade: 2, valorUnitario: 40.00, fatorHecto: 0.12, fatorEmbalagem: 12,
    motorista: "JOSICLAUDIO DE OLIVEIRA RODRIGUES", motoristaCpf: "079.431.824-11", rota: "R106",
    mapa: "M12050", nf: "261680", clienteNb: "CLI2390", clienteNome: "RESTAURANTE FIM DE ANO",
    ajudante1: "JOSE DE MESQUITA FABRICIO", ajudante1Cpf: "091.642.784-23",
    turno: "Diurno (Turno 1)", horario: "14:15",
    observacao: "Falta de 2 cx no PDV (R$ 80,00). Vale emitido e assinado."
  },
  {
    month: 12, day: 22, tipo: "carregamento",
    motivo: "Falta de SKU no Carregamento (Armazém)",
    subMotivo: "Separação Incompleta no Palete",
    produtoCodigo: "1743", produtoDescricao: "ANTARCTICA PILSEN GFA VD 1L COM TTC",
    quantidade: 2, valorUnitario: 43.50, fatorHecto: 0.12, fatorEmbalagem: 12,
    motorista: "ADELSON SANTOS DE ARAUJO", motoristaCpf: "101.598.524-63", rota: "R113",
    mapa: "M12080", nf: "261890", clienteNb: "CLI3430", clienteNome: "BAR DA PRAIA",
    turno: "Diurno (Turno 1)", horario: "07:10",
    observacao: "Ajuste físico final de dezembro no CD."
  }
];
...
export function generateHistoricalShortagesAndVales2026(): {
  ...
  RAW_SHORTAGE_EVENTS_2026.forEach((evt, idx) => {
    const seq = 1000 + idx;
